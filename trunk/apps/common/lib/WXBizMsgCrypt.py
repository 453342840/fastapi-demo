...
from apps.common.lib import WXBizMsgCryptError
...
class SHA1:
    ...
    def getSHA1(self, token, timestamp, nonce, encrypt=None):
        ...
        try:
            ...
            return WXBizMsgCryptError.WXBizMsgCrypt_OK, sha.hexdigest()
        except Exception as e:
            logger.error(e)
            return WXBizMsgCryptError.WXBizMsgCrypt_ComputeSignature_Error, None
...
class XMLParse:
    ...
    def extract(self, xmltext):
        ...
        try:
            ...
            return WXBizMsgCryptError.WXBizMsgCrypt_OK, encrypt.text, touser_name.text
        except Exception as e:
            logger.error(e)
            return WXBizMsgCryptError.WXBizMsgCrypt_ParseXml_Error, None, None
...
class Prpcrypt(object):
    ...
    def encrypt(self, text, appid):
        ...
        try:
            ...
            return WXBizMsgCryptError.WXBizMsgCrypt_OK, base64.b64encode(
                ciphertext).decode('utf8')
        except Exception as e:
            #print(e)
            return WXBizMsgCryptError.WXBizMsgCrypt_EncryptAES_Error, None
    ...
    def decrypt(self, text, appid):
        ...
        try:
            ...
            # print(e)
            return WXBizMsgCryptError.WXBizMsgCrypt_DecryptAES_Error, None
        try:
            ...
            return WXBizMsgCryptError.WXBizMsgCrypt_IllegalBuffer, None
        if from_appid != appid:
            return WXBizMsgCryptError.WXBizMsgCrypt_ValidateAppid_Error, None
...
class WXBizMsgCrypt(object):
    ...
    def __init__(self, sToken, sEncodingAESKey, sAppId):
        try:
            ...
            throw_exception("[error]: EncodingAESKey unvalid !",
                            FormatException)
        #return WXBizMsgCryptError.WXBizMsgCrypt_IllegalAesKey)
        self.token = sToken
    ...
    def DecryptMsg(self, sPostData, sMsgSignature, sTimeStamp, sNonce):
        ...
        if not signature == sMsgSignature:
            return WXBizMsgCryptError.WXBizMsgCrypt_ValidateSignature_Error, None
        pc = Prpcrypt(self.key)
